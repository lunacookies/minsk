...
public sealed class Binder
{
    ...
    private BoundExpression BindUnaryExpression(UnaryExpressionSyntax syntax)
    {
        ...
        return new BoundUnaryExpression((BoundUnaryOperatorKind)boundOperatorKind, boundOperand);
    }
    ...
    private BoundExpression BindBinaryExpression(BinaryExpressionSyntax syntax)
    {
        ...
        return new BoundBinaryExpression(boundLeft, (BoundBinaryOperatorKind)boundOperatorKind, boundRight);
    }
